...
const translations: Record<Language, Record<string, string>> = {
  bn: {
    // Branding & Header
    collegeName: "আব্দুল ওদুদ শাহ ডিগ্রী কলেজ",
    collegeNameEMS: "আব্দুল ওদুদ শাহ ডিগ্রী কলেজ ইএমএস",
    ...
    principalName: "ড. মোঃ রফিকুল ইসলাম",
    ...
    aboutHistoryText: "আব্দুল ওদুদ শাহ ডিগ্রী কলেজ ২৩ জুন ১৯৯৪ সালে চুয়াডাঙ্গা জেলার দামুড়হুদা উপজেলায় প্রতিষ্ঠিত হয়। প্রতিষ্ঠালগ্ন থেকে এই কলেজ উচ্চ মাধ্যমিক, ডিগ্রী এবং অনার্স পর্যায়ে মানসম্মত শিক্ষা প্রদান করে আসছে। গ্রামীণ অঞ্চলের শিক্ষার্থীদের উচ্চশিক্ষার সুযোগ সৃষ্টিতে এই প্রতিষ্ঠান অগ্রণী ভূমিকা পালন করছে।",
